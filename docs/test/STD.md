...
## 5. CSM — Core System Model (SaaG-CSM)
...
**TC-CSM-03: Model Access Provider**
...
**TC-CSM-05: Candidate Evaluation Model Builder**
Traces to: CSM.31 / SDD §3.5.2
...
**TC-CSM-06: Analytical Data Ingestion**
...
Procedure:
1. Bind the ingested Analytical Evaluation Data to the Core System Model built in TC-CSM-01, associating it with the correct project/platform/system version/model.
...
**TC-CSM-08: Unmatched Record Reporter**
Traces to: CSM.37 / SDD §3.5.2
...
5. Verify the resulting project/platform/system-version association and the CSM matching/binding status are displayed.
...
3. Run a verification operation against the updated working model instead of the Core System Model.
...
| TC-CSM-04 | Concurrency & Session Manager | CSM.29–30 |
| TC-CSM-05 | Candidate Evaluation Model Builder | CSM.31 |
